 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
         <div class="sidebar-brand-icon">
             <img src="/images/logodesa.png" alt="KAI Logo" style="width: 40px; height: auto;">
         </div>
         <div class="sidebar-brand-text mx-3">Desa <sup>KLN</sup></div>
     </a>
     ...
     <li class="nav-item {{ request()->is('admin/report*') ? 'active' : '' }}">
         <a class="nav-link" href="{{ route('admin.report.map') }}">
             <i class="fas fa-fw fa-table"></i>
             <span>Peta Laporan</span></a>
     </li>
